      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="/jobs" className="group p-6 bg-linear-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-100 hover:border-blue-300 hover:shadow-lg transition-all duration-300 hover:scale-105">
            ...
            <a href="/candidates" className="group p-6 bg-linear-to-br from-purple-50 to-pink-50 rounded-xl border-2 border-purple-100 hover:border-purple-300 hover:shadow-lg transition-all duration-300 hover:scale-105">
